...
const Detail = () => {
  ...
  const [data, serData] = useState<Data>({} as Data)
  const routeParams = route.params as Params;
  
  useEffect(()=>{
    services.get(`points/${routeParams.point_id}`)
  ...
  const handleWhatsapp = () => {
    Linking.openURL(`whatsapp://send?phone=+5583987357305&text=testando o whatsapp`)
  }
